...
def r2_scoring(request):
    user = CustomUser.objects.get(id=request.user.id)
    context = {
        "user": user,
    }
    return render(request, "user_templates/r2_page.html", context)
...
def thank(request):
    ...
    return render(request, "user_templates/thank.html", context)
    ...
    if request.method != "POST":
        ...
        try:
            ...
            if robot == "r1":
                ...
                user.r1feeling1 = request.POST.get("feeling1")
                user.r1feeling2 = request.POST.get("feeling2")
                user.r1feeling3 = request.POST.get("feeling3")
            if robot == "r2":
                user.r2feeling = request.POST.get("feeling")
                user.r2feeling1 = request.POST.get("feeling1")
                user.r2feeling2 = request.POST.get("feeling2")
                user.r2feeling3 = request.POST.get("feeling3")
            user.save()
